...
const baseClasses =
  'w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-charcoal placeholder:text-gray-400 focus:border-regal focus:outline-none focus:ring-1 focus:ring-regal'
